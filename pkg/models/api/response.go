...
type ProcessDocumentResponse struct {
	...
	Metadata             *core.DocumentMetadata `json:"metadata,omitempty"`
...
type IndexDocumentResponse struct {
	DocumentID string    `json:"document_id"`
	IndexID    string    `json:"index_id,omitempty"`    // ID returned by search engine
	IndexName  string    `json:"index_name,omitempty"`  // Name of the index
	Success    bool      `json:"success"`
	Message    string    `json:"message,omitempty"`     // Success or informational message
